...
{
	Image2->Picture->LoadFromFile("да_1.png");
}
//---------------------------------------------------------------------------
void __fastcall TFAnswer::Image2MouseLeave(TObject *Sender)
{
	Image2->Picture->LoadFromFile("да.png");
}
//---------------------------------------------------------------------------
...
{
	Image3->Picture->LoadFromFile("нет_1.png");
}
//---------------------------------------------------------------------------
void __fastcall TFAnswer::Image3MouseLeave(TObject *Sender)
{
	Image3->Picture->LoadFromFile("нет.png");
}
//---------------------------------------------------------------------------
void __fastcall TFAnswer::Image3Click(TObject *Sender)
{
    FAnswer->Close();
}
//---------------------------------------------------------------------------
