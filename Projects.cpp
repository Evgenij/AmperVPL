...
void __fastcall TFProject::FormActivate(TObject *Sender)
{
	...
	int a=MessageDlg("Хотите сохранять действия в отдельный файл?",mtInformation,TMsgDlgButtons()<<mbOK<<mbNo,0);
	if(a==mrOk)
	{
		SD->Execute();
...
void __fastcall TFProject::im2Click(TObject *Sender)
{
	...
	FProjects->lab->Caption = "Лабораторная работа №2";
...
void __fastcall TFProject::im3Click(TObject *Sender)
{
	...
	nlab = 3;
	FProjects->lab = new TMain(Main);
	FProjects->lab->Caption = "Лабораторная работа №3";
...
void __fastcall TFProject::im4Click(TObject *Sender)
{
	nlab = 4;
	FProjects->lab = new TMain(Main);
	FProjects->lab->Caption = "Лабораторная работа №4";
...
void __fastcall TFProject::im5Click(TObject *Sender)
{
	nlab=5;
	FProjects->lab = new TMain(Main);
	FProjects->lab->Caption = "Лабораторная работа №5";
...
void __fastcall TFProject::im7Click(TObject *Sender)
{
	nlab=6;
	FProjects->lab = new TMain(Main);
	FProjects->lab->Caption = "Лабораторная работа №6";
...
void __fastcall TFProject::im8Click(TObject *Sender)
{
	...
	if(FProjects->memo!=NULL)
	{
		...
		FProjects->memo->Lines->Add("ЛАБОРАТОРНАЯ РАБОТА №7");
